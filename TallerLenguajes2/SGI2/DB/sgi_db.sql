...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-05-2024 a las 17:45:57
...
INSERT INTO `acceso` (`user`, `pass`, `roles_fk`) VALUES
('albornoz', 'contra', 5),
('ana', 'contra', 0),
('brian', 'contra', 0),
('henry', 'contra', 1),
...
(1, 'riel de aire', 'implemento', 'https://azeheb.com/media/catalog/product/cache/3/image/9df78eab33525d08d6e5fb8d27136e95/t/r/trilho_de_ar_novo_web.jpg', 2, 'https://azeheb.com/es/riel-lineal-de-aire.html', 'Ofi', 7),
(2, 'Etanol', 'sustancia', '', NULL, '', 'E2', 4),
(3, 'Erlenmeyer En Vidrio De 200', 'implemento', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYOVWAl6FRJtduL0chUokEcL1sJ8jB7jevKay2w9YsqSr4D1JKh2DHjXRu4Qwng6AA', 9, 'https://articulo.mercadolibre.com.co/MCO-836416066-erlenmeyer-en-vidrio-de-200-ml-schott-_JM', 'E2', 7),
...
--
ALTER TABLE `insumo`
  MODIFY `id_insumo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `implemento`
  ADD CONSTRAINT `fk_IMPLEMENTO_INSUMO` FOREIGN KEY (`insumoI_fk`) REFERENCES `insumo` (`id_insumo`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `practica`
  ...
  ADD CONSTRAINT `fk_PRACTICA_INSUMO` FOREIGN KEY (`insumo_fk`) REFERENCES `insumo` (`id_insumo`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `reg_entrada`
--
ALTER TABLE `reg_entrada`
  ADD CONSTRAINT `fk_REG_ENTRADA_INSUMO` FOREIGN KEY (`insumo_entra_fk`) REFERENCES `insumo` (`id_insumo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `reg_salida`
  ADD CONSTRAINT `fk_REG_SALIDA_INSUMO` FOREIGN KEY (`insumo_sale_fk`) REFERENCES `insumo` (`id_insumo`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `sustancia`
--
ALTER TABLE `sustancia`
  ADD CONSTRAINT `fk_SUSTANCIA_INSUMO` FOREIGN KEY (`insumo_fk`) REFERENCES `insumo` (`id_insumo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_SUSTANCIA_PALABRA_SEGURIDAD` FOREIGN KEY (`palabra_seguridad_fk`) REFERENCES `palabra_seguridad` (`id_palabra`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `transaccion`
  ...
  ADD CONSTRAINT `fk_TRANSACCION_INSUMO` FOREIGN KEY (`insumo_transa_fk`) REFERENCES `insumo` (`id_insumo`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
