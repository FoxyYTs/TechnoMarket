...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2024 a las 00:40:38
...
ALTER TABLE `reg_entrada`
  ...
  ADD KEY `fk_REG_ENTRADA_ACCESO` (`user_fk`),
...
ALTER TABLE `reg_salida`
  ...
  ADD KEY `fk_REG_SALIDA_ACCESO` (`user_fk`),
...
ALTER TABLE `reg_entrada`
  ...
  ADD CONSTRAINT `fk_REG_ENTRADA_ACCESO` FOREIGN KEY (`user_fk`) REFERENCES `acceso` (`user`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `reg_salida`
  ...
  ADD CONSTRAINT `fk_REG_SALIDA_ACCESO` FOREIGN KEY (`user_fk`) REFERENCES `acceso` (`user`) ON DELETE NO ACTION ON UPDATE NO ACTION;
