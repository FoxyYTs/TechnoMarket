...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2024 a las 17:15:36
...
--
ALTER TABLE `implemento`
  ADD CONSTRAINT `fk_IMPLEMENTO_INSUMO` FOREIGN KEY (`insumoI_fk`) REFERENCES `insumo` (`id_insumo`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
--
ALTER TABLE `sustancia`
  ADD CONSTRAINT `fk_SUSTANCIA_INSUMO` FOREIGN KEY (`insumo_fk`) REFERENCES `insumo` (`id_insumo`) ON DELETE CASCADE ON UPDATE NO ACTION,
