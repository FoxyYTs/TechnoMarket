...
class Automovil(Vehiculo):
    def __init__(self, id=""):
        self.hojaAutomovil = pd.read_excel("./tp1Sesiones/Entregable2/resources/Clases.xlsx","ClaseAutomovil",index_col="placa")
        self.hojaVehiculo = pd.read_excel("./tp1Sesiones/Entregable2/resources/Clases.xlsx","ClaseVehiculo",index_col="id")
        """Automovil
